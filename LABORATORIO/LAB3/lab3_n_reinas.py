...
Original file is located at
    https://colab.research.google.com/drive/1MgX1yJ2C4u7m6DKlWPr5Gh5Kdn29fKd1
...
class ProblemaBusqueda(object):
    ...
    def resultado(self, estado, accion, cont=0):
...
def disponibles(y, n, columna, diagonal_derecha, diagonal_izquierda):
...
#for i in range(10):
    ...
    for y in range(n):
        ...
        columnas_d = disponibles(y, n, columna, diagonal_derecha, diagonal_izquierda)
...
if __name__ == '__main__':
  reinas = int(input('¿CUANTAS REINAS QUIER USAR?   '))
  solucion = n_reinas(reinas)
  print(solucion)
